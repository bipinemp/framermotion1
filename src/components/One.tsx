...
function One() {
  ...
  return (
    <div className="relative overflow-hidden h-screen flex items-center justify-center bg-blue-300">
      <motion.div
        ref={ref}
        variants={container}
        initial="hidden"
      ...
      >
        <motion.h1 variants={element}>One Number</motion.h1>
        <motion.h3 variants={element}>FirstPage</motion.h3>

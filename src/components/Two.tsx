...
function Two() {
  ...
  return (
    <div className="relative overflow-hidden h-screen flex items-center justify-center bg-purple-300">
      <motion.div
        ref={ref}
        variants={container}
        initial="hidden"
      ...
      >
        <motion.h1 variants={element}>Two Number</motion.h1>
        <motion.h3 variants={element}>SecondPage</motion.h3>
